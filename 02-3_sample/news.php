...
try {
  ...
  //
  // 補足：
  // 下記SQLに「WHERE posted <= CURDATE()」を付けると配信予約が可能になる
  //--------------------
      ...
      <div class="col-md-9 col-xs-12 margin-top-md">
        ...
        <div class="well well-lg">
          <div class="media">
            <a class="pull-left">
              <?php if($item["image"]): ?>
              <img class="media-object" src="images/press/<?php echo $item["image"]; ?>" height="64" width="64" alt="">
              <?php else: ?>
        ...
        <?php endforeach;?>
      </div><!-- .col-md-9 .col-xs-12 .margin-top-md -->
