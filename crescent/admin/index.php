...
try {
	...
	// Get news data
	$stmt = $pdo->query("
			select id, posted, title, message, image
			from news
  ...
  <main>
    ...
    <table>
      ...
      <tr>
        ...
        <td class="center"><img src="../images/press/press03.jpg" width="64" height="64" alt=""></td>
        <td class="center"><a href="news_edit.html?id=3">編集</a></td>
        <td class="center"><a href="news_delete.html?id=3">削除</a></td>
      </tr>
      <tr>
        ...
        <td class="center"><a href="news_edit.html?id=2">編集</a></td>
        <td class="center"><a href="news_delete.html?id=2">削除</a></td>
      </tr>
      <tr>
        ...
        <td class="center"><a href="news_edit.html?id=1">編集</a></td>
        <td class="center"><a href="news_delete.html?id=1">削除</a></td>
      </tr>
    </table>
  </main>
  <footer>
