          ...
          <div class="col-md-8">
            ...
            <input type="hidden" name="token" value="<?php echo getToken(); ?>">
              <div class="form-group">
                ...
                <?php endif; ?>
                  <input type="text" class="form-control" id="inputname"  name="name"  value="<?php echo h($name); ?>">
              ...
              <div class="form-group">
                ...
                <?php endif; ?>
                  <input type="text" class="form-control" id="inputkana"  name="kana"  value="<?php echo h($kana); ?>">
              ...
              <div class="form-group">
                ...
                <?php endif; ?>
                  <input type="email" class="form-control" id="inputemail" name="email" value="<?php echo h($email); ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="tel" class="form-control" id="inputtel" name="phone" value="<?php echo h($phone); ?>">
              ...
              <div class="form-group">
                ...
                <?php endif; ?>
                  <textarea rows="10" cols="100" class="form-control" id="message"  name="inquiry" maxlength="999" style="resize:none"><?php echo h($inquiry); ?></textarea>
                </div>
              </div>
              <div class="form-group">
